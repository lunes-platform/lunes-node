...
object Constants extends ScorexLogging {
  val VersionStr = "0.0.8"
  val VersionTuple = (0, 0, 8)
  val MinimalVersion = (0, 0, 1)
  ...
  val TestTransactions = List(
    GenesisTransactionSettings("37buuGA1KBFiaMmgtZojvkaRwifCdZbUNuq",
                               5000000000000L),
    GenesisTransactionSettings("37VVpvgHjnNY9hfggyAbfMzvaD6Ewo7Cfcj",
                               5000000000000L),
    GenesisTransactionSettings("37gKHykxhd8n5MhzjsETtVi9Pp12ximAkY7",
                               40000000000000000L),
    GenesisTransactionSettings("37d1vG9NPjnkpyFErNdnyKXLoRzoEYGyxYu",
                               40000000000000000L)
  )
