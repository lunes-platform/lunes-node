...
import io.lunes.settings.{BlockchainSettings, FunctionalitySettings}
...
import io.lunes.transaction.PoSCalc.{calcBaseTarget, calcGeneratorSignature, calcHit, calcTarget, _}
