...
case class BlocksApiRoute(
  ...
  @ApiOperation(
    value = "Address",
    notes =
      "Get list of blocks size of MaxBlocksPerRequest generated by specified address",
    httpMethod = "GET"
  )
  @ApiImplicitParams(
    Array(
  ...
  def address: Route =
    (path("address" / Segment / IntNumber / IntNumber) & get) {
      case (address, start, end) =>
        if (
          end >= 0 && start >= 0 && end - start >= 0 && end - start < MaxBlocksPerRequest
        ) {
          val blocks = JsArray(
            (start to end)
              .map { height =>
  ...
  @ApiOperation(
    value = "Seq",
    notes =
      "Get list of block of size MaxBlocksPerRequest at specified heights",
    httpMethod = "GET"
  )
  @ApiImplicitParams(
    Array(
  ...
  @ApiOperation(
    ...
    notes =
      "Get list of block of size MaxBlocksPerRequest without transactions payload at specified heights",
    httpMethod = "GET"
  )
  @ApiImplicitParams(
    Array(
